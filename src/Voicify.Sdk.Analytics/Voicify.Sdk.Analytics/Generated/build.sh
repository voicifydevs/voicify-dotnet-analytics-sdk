...
${nuget_cmd} install src/Voicify.Sdk.Analytics/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Voicify.Sdk.Analytics.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Voicify.Sdk.Analytics.dll \
-recurse:'src/Voicify.Sdk.Analytics/*.cs' \
-doc:bin/Voicify.Sdk.Analytics.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Voicify.Sdk.Analytics.dll was created successfully"
fi
